...
import model, schemas, database, oauth2
...
def get_single_blog(id,response: Response, db: Session = Depends(get_db), current_user: schemas.User= Depends(oauth2.get_current_user)):
